      ...
      <div id="content-wrapper">
        ...
        <div class="container content">
            <form action="update.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="id" class="form-controls" value="<?php echo $row["id"]; ?>">
                <div class="form-group">
                    <input type="text" name="name" class="form-control" value="<?php echo $row["name"]; ?>">
                </div>

                <div class="form-group">
                  <input type="file" class="form-control-file border" name="photo" value="<?php $image = $row["img_dir"]; echo $image;?>">
                </div>

                <div class="form-group">
                    <input type="text" name="message" class="textarea" value="<?php echo $row["remark"]; ?>">
                </div>
