<?php
    include("../dbsystem/config.php");
        ...
        //         move_uploaded_file($file_tmp,"admin/dashboard/photo/" .$file_name);
        // }
        ...
        {       
            ...
            move_uploaded_file($_FILES["photo"]["tmp_name"], "admin/dashboard/photo/" . $_FILES["photo"]["name"]);
                                ...
                                <div class='blog-author'>
                                    <div class='row'>
                                        ...
                                        <div class='blog-post-image'>
                                            <img src='../".$filename ."' class='text-center blog-image' width='100%'>
                                        </div>
