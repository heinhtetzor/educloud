<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM Daily_news_&_Updates ORDER BY id DESC");
?>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item active"">
          <a class="nav-link" href="previews.php">
          <i class="fas fa-cloud-upload-alt"></i>
      ...
      <div id="content-wrapper">
        ...
        <div class="container content">
            <form action="daily_news_post.php" method="post" enctype="multipart/form-data">
