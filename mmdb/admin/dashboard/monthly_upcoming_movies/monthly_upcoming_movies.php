...
<!DOCTYPE html>
    <html lang='en'>
        ...
        $create_file_name = fopen('../../../Monthly_Upcoming_Movies/'. $title . '.html', 'w') or die('You are not allowed');

        echo fwrite($create_file_name, $template);

         
    
        $sql = "INSERT INTO `Monthly_upcoming_movies` (name, remark,created_date)
